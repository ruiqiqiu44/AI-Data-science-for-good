...
function WordCard({ word, emoji, bg, color, meaning }: WordEntry) {
  return (
    <div style={{ borderRadius: 20, background: '#fff', overflow: 'hidden',
      ...
      <div style={{ padding: '10px 12px 12px' }}>
        ...
        <button onClick={() => speak(word)} style={{ width: '100%', border: 'none',
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '1.25rem' }}>
        ...
        {imageUrl && (
          <div style={{ borderRadius: 20, overflow: 'hidden', marginBottom: 16,
            ...
            <div style={{ position: 'absolute', top: 12, right: 12, background: 'rgba(0,0,0,0.55)',
        ...
        {phase === 'done' && rawText && (
          <div style={{ background: '#1e293b', borderRadius: 16, padding: '14px 16px', marginBottom: 16 }}>
            <div style={{ fontSize: 10, fontWeight: 800, color: '#64748b',
              textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: 8 }}>Text found in photo</div>
            <div style={{ fontSize: 13, color: '#94a3b8', fontFamily: 'monospace',
              lineHeight: 1.6, maxHeight: 80, overflowY: 'auto' }}>{rawText}</div>
          </div>
        )}
